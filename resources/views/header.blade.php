            ...
            <div class="container header__wrap">
                ...
                <nav class="nav js-burger" id="nav">
                    ...
                    <ul class="nav__list">
                        ...
                        <li class="nav__item"><a href="/portfolio">Portfolio</a>
                            <span class="nav__icon">
                                <svg height="128px" id="Layer_1" style="enable-background:new 0 0 128 128;" version="1.1"
                                    ...
                                    <g>
                                        <line
                                            style="fill:none;stroke:#000;stroke-width:12;stroke-linecap:square;stroke-miterlimit:10;"
                        ...
                        <li class="nav__item"><a href="/contact">Contact Me</a></li>
                    </ul>
                    <div class="nav-footer">
                        <ul class="nav-footer__list">
                            <div class="nav-footer__item">
                                ...
                                <a href="tel:+18005596580" class="nav-footer__link ">+1 800 559 6580</a>
                            </div>
                            <div class="nav-footer__item">
                                <span class="nav-footer__icon">
                                    <?xml version="1.0" encoding="iso-8859-1"?>
                                ...
                                <a href="mailto:mail@mail.mail" class="nav-footer__link">mail@mail.mail</a>
                            </div>
                        </ul>
                        <div class="nav-social">
                            <ul class="nav-social__list">
                                ...
                                <li class="nav-social__item">
                                    <a href="" class="nav-social__link fa fa-google-plus"></a>
                                </li>
                                <li class="nav-social__item">
                                    <a href="" class="nav-social__link fa fa-500px"></a>
                                </li>
                                <li class="nav-social__item">
                                    <a href="" class="nav-social__link fa fa-behance"></a>
                                </li>
                            </ul>
                        </div>
                        <div class="policy">
